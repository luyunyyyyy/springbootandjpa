...
import com.luyunyyyyy.service.DeskRepository;
import com.luyunyyyyy.service.ReservationRecordRepository;
...
public class RecordController {
    ...
    public String finishRecord(@Param("userStuNumber") Long userStuNumber) throws JsonProcessingException {
        ObjectMapper mapper = new ObjectMapper();
        ReservationRecord temp = reservationRecordRepository.findByRecordUserIdAndRecordState(userStuNumber, "进行中");
        if (temp == null)
